...
export default function Trip() {
   ...
   //-----------------------------------------
    ...
    useEffect(() => {
        console.log("Tela Incluir Viagem")
        fTripCarregaDados()
                ...
                {!loading && (
                    <View style={styles.container}>
                        ...
                        <View style={styles.contorno}>
                            <Text style={styles.tripTitTopo}>REGISTAR VIAGEM:</Text>
                            ...
                            {loading && (
                                ...
                                <View style={styles.trip}>
                                    ...
                                    <View style={styles.grupo_campos}>
                                        ...
                                        <Pressable style={styles.custom_date} onPress={showDatepicker}>
                                            <TextInput 
                                    ...
                                    <View style={styles.grupo_campos}>
                                        ...
                                        <Pressable style={styles.custom_date} onPress={showTimepicker}>
                                            <TextInput 
                                                style={styles.campo_date}
                                                placeholder="DD/MM/YYYY"
                                                placeholderTextColor="#888"
                                    ...
                                    <View style={styles.grupo_campos}>
                                        <CheckBox 
                                            ...
                                            onValueChange={setViagemIdaVolta}
                                        />
